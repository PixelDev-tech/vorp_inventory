...
RegisterNUICallback('SetHotbar', HotbarService.NUISetHotbar)
RegisterNUICallback('SetUiBusy', HotbarService.NUISetUiBusy)
RegisterNUICallback('SetHotbarEnabled', HotbarService.NUISetHotbarEnabled)
